...
const Topbar = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-[#0B1C2C] via-[#0F2A43] to-[#0B1C2C] text-white fixed top-0 z-[1000] shadow-lg border-b border-white/5">
      ...
      <div className="max-w-7xl mx-auto h-[44px] px-4 flex items-center gap-6 overflow-hidden">
        ...
        <div className="flex items-center gap-3 whitespace-nowrap flex-shrink-0">
          ...
          <p className="text-[12px] tracking-wide">
            <span className="font-extrabold text-blue-400">PROMO:</span> Get <span className="text-white font-bold underline decoration-blue-500/50 underline-offset-2">20% OFF</span> on premium leads!
          </p>
        </div>
        ...
        <div className="flex-shrink-0 flex items-center gap-5">
          <button 
            ...
            className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-500 text-white text-[12px] font-bold px-6 py-[8px] rounded-full transition-all shadow-md shadow-green-900/20 active:scale-95 uppercase tracking-wider"
          >
            Partner Join
          </button>
        </div>
